...
<div class="weui-cells_form">
    ...
    <div class="weui-btn-area">
        <input class="device device-fixed" name="trace_code" type="text" placeholder="请输入追溯码">
    </div>
    <div class="weui-btn-area">
        <a class="weui-btn weui-btn_primary" href="javascript:trace();" id="showTooltips">一键溯源</a>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function trace() {
    	var trace_code = $("input[name='trace_code']").val();
    	window.location = '${path}/moblie/trace/inquiry_detail.htm?trace_code='+trace_code;
	}
</script>
</body>
</html>