...
var edit_form_panel = Ext.create("Ext.form.Panel", {
	url : getServerHttp() +"/cp/grid/template/edit.htm",
	buttonAlign : "center",
	...
	items : [{
		...
		xtype : "panel",
		html : '<iframe src= "eeditors.html" width="100%" height="100%" marginwidth="0" framespacing="0" marginheight="0" frameborder="0" ></iframe>',
		width : '100%',
		height : 650,
		border : false,
		style : {
...
function myEdit(kid) {
	Ext.Ajax.request({
		url : getServerHttp() +"/cp/grid/template/edit_form.htm?kid=" + kid,
