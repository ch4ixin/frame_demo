var edit_form_panel = Ext.create("Ext.form.Panel", {
	...
	items : [{
		...
		items : [{
					...
					items : [{
						xtype : "panel",
						html : '<div><img id="logo_img5" src="../../resource/img/product.png" width="120" height="120"></div>'
...
function myEdit(kid) {
	...
	Ext.Ajax.request({
		...
		success : function(response) {
			...
			$("#logo_img5").attr("src",getServerHttp()+"/img/"+json.shop.logo_file_id+".htm?mw=120&mh=120");
			console.log(getServerHttp()+"/img/"+json.shop.logo_file_id+".htm");
