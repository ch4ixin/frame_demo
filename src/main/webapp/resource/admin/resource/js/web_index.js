...
function select_recommend_goods(goods_id) {//商品选择
	...
	text_append += '<i></i>';
  	text_append += '<img select_goods_id="'+goods_id+'" title="'+goods_name+'" goods_name="'+goods_name+'" src="'+goods_pic+'" onload="DrawImage(this,72,72);" />';
...
function select_brand(brand_id) {//品牌选择
	...
	text_append += '<i></i>';
	text_append += '<img ondblclick="del_brand('+brand_id+');" select_brand_id="'+brand_id+'" brand_name="'+brand_name+'" src="'+brand_pic+'" onload="DrawImage(this,68,34);" />';
	text_append += '</span></div>';
...
function select_sale_goods(goods_id){//商品选择
	...
	text_append += '<span class="thumb size-72x72">';
	text_append += '<i></i>';
  	text_append += '<img select_goods_id="'+goods_id+'" title="'+goods_name+'" goods_name="'+goods_name+'" src="'+goods_pic+'" goods_price="'+goods_price+'" market_price="'+market_price+'" onload="DrawImage(this,72,72);" />';
	text_append += '</span></div>';
	text_append += '<div class="goods-name">';
