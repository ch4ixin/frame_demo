                                    ...
                                    <div class="panel-body">
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab-2">
                                            	<img style="width: 49.5%;height: 700px;border: 3px solid #39aef5;border-radius: 5px;" alt="image" src="${yylicense.img_url }">
                                            	<img style="width: 49.5%;height: 700px;border: 3px solid #39aef5;border-radius: 5px;" alt="image" src="${sclicense.img_url }">
                                            </div>
                                        </div>
                                    </div>
                                </div>
