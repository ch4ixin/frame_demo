...
<body class="fixed-sidebar full-height-layout gray-bg  pace-done skin-1" style="overflow:hidden">
    <div id="wrapper">
                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span>
                            	...
                            	<c:if test="${!chk_root}">
	                            	<img alt="image" class="img-circle" src="${path}/resource/img/user.png" />
								</c:if>
                            </span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            	...
                            	<c:if test="${!chk_root}">
                               	 ...
                               	 <span class="block m-t-xs"><strong class="font-bold">${admin.name}</strong> <span style="opacity: 0.8;"></span><b class="caret"></b></span>
                                </span>
                            </a>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                        <div class="navbar-form-custom">
                           <div id="update_alt" style="display: none">
	                            <div class="form-group-top">
		                                ...
		                                <input type="text" style="font-weight:900;color: black" value="同步数据中..." class="form-control"  readonly="readonly">
	                            </div>
                            </div> 
                            <div id="ben_alt" style="display: display">
            ...
            <div class="footer">
                <div class="pull-right">&copy; 2019 <a href="http://www.sxxlkj.com/" target="_blank">讯龙科技</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
        ...
        <div class="small-chat-box fadeInRight animated">
            ...
            <div class="form-chat">
                <div class="input-group input-group-sm">
                    <img style="width: 100%;" src="${path}/resource/img/xlkj.jpg" /> 
                </div>
            </div>
    ...
    <script type="text/javascript">
         ...
         /* window.setInterval(function(){
			$.ajax({
               url: "${path}/shop/ai/units/user/sync_data.htm?units_id=EQ8FTaRLJqoDYumxPNPhYY",
               success: function(result) {
	               	result = $.parseJSON(result);
	               	//console.log(result);
					document.getElementById("update_alt").style.display="none";
		    		document.getElementById("ben_alt").style.display="";
               },
