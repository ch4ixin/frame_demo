...
public class TreeTools {
	...
	// 预处理树节点
		...
		// 预处理树节点
		public static List<Map<String, Object>> unitsTree(List<Map<String, Object>> menuList, boolean isChecked) {
			for (Map<String, Object> map : menuList) {
				map.put("id", map.get("code"));
				map.put("iconCls", map.get("url"));
		...
		@SuppressWarnings("unchecked")
		public static String unitsListToTree(List<Map<String, Object>> menuList, boolean isChecked) {
			// TODO 转换List为树形结构
			menuList = unitsTree(menuList, isChecked);
