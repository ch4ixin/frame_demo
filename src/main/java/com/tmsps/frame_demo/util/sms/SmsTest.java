package com.tmsps.frame_demo.util.sms;

import com.tmsps.frame_demo.model.t_fk_sms;
import com.tmsps.frame_demo.util.http.SSLHttpClient;
...
public class SmsTest {
    ...
    private static HttpResponse get(String cType, String accountSid,
        ...
        requestBody
                .setContent(new ByteArrayInputStream(body.getBytes(StandardCharsets.UTF_8)));
