package com.tmsps.frame_demo.action_cp.admin;
...
import com.tmsps.frame_demo.service.AdminService;
...
public class AdminController extends ProjBaseAction {
	...
	public void pwd(String currentpwd, String newpwdone) {
		...
		if (MD5Util.MD5(currentpwd).equals(currentUser.getPwd())) {
			t_fk_admin userDb = bs.findById(currentUser.getKid(), t_fk_admin.class);
