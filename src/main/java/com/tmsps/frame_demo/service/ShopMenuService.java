...
import com.tmsps.frame_demo.model.t_shop_menu_auth;
...
public class ShopMenuService extends BaseService {
	...
	public t_shop_menu_auth findAuthByCode(String code,String menu_id) {
		...
		t_shop_menu_auth shop_menu_auth = bs.findObj(sql, new String[] { code,menu_id }, t_fk_auth.class);
	...
	public t_shop_menu_auth findAuthByCode(String kid, String code,String menu_id) {
		...
		t_shop_menu_auth shop_menu_auth = bs.findObj(sql, new String[] { code, kid ,menu_id }, t_shop_menu_auth.class);
		return shop_menu_auth;
	}
	// ------------------------- end ------------------------------
