...
import com.tmsps.frame_demo.model.t_fk_sms_template;
import com.tmsps.frame_demo.util.json.JsonTools;
import com.tmsps.frame_demo.util.sms.SmsTest;
...
public class SmsService extends BaseService {
	...
	public boolean sendSms(String mobile, String smsTempCode, String code) {
        ...
        return "000000".equals(end.getJSONObject("resp").getString("respCode"));
	}
